import {
  statusClienteFilterData,
  statusFilterData,
  tipoPessoaFilterData,
} from "@components/filtro-avancado/model";
...
export function SelectStatusContaPagar({ chave }: any) {
